...
func getIndex(w http.ResponseWriter, r *http.Request) {
	fmt.Fprint(w, "<html>GoCryptoTrader RESTful interface. For the web GUI, please visit the <a href=https://github.com/agentbunny/gocryptotrader/blob/master/web/README.md>web GUI readme.</a></html>")
